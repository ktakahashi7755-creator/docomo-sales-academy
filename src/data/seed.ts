...
export const PHASES: Phase[] = [
  {
    ...
    title: "現場基礎",
    summary:
      "ヘルパーの役割、店内/イベント/外販の動き、受付から提案までの流れ、接客の標準5ステップと自責思考、コンプライアンス。",
    modules: [
      {
        id: "p1m1",
        title: "携帯販売ヘルパーの役割",
  ...
  },
  {
    ...
    title: "ヒアリング",
    summary:
      "モール通行・他社利用で乗り換え抵抗が強い相手を前提に、聞かないと出てこない現状・不満・自宅Wi-Fi・乗り換え意欲を引き出す。書類/未納/家族相談も早期確認。",
    modules: [
      {
        id: "p6m1",
        title: "基本ヒアリングの型",
  ...
  },
  {
    ...
    title: "提案設計",
    summary:
      "端末スペック・料金最適化・自宅ネットの3価値を連動。安さでなく『乗り換え後の明るい未来』として束ね、単品/セット/家族まとめ/MNP/dカード/光/home 5G/ポイ活へ。",
    modules: [
      {
        id: "p7m1",
        title: "単品提案・セット提案",
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "複数端末の同時利用に強い",
      "光セット割の対象",
      "ワンコイン特典：対象期間中は月額500円・新規工事料無料（条件・期間あり）",
    ],
    warnings: [
      "提供エリア・対応プロバイダ・対応ルーターを確認",
      "1ギガとの料金差を説明",
      "『月額500円・工事料無料』はキャンペーンのため、対象期間・適用条件を公式と最終確認日で照合する（要確認）",
    ],
    timing: "速度の不満があるお客様、ゲーム/在宅勤務ユーザー。キャンペーン期間中は導入の好機。",
    hearing: ["利用用途（ゲーム/在宅/動画）", "同時接続台数", "提供エリア"],
    pitch: [
      "用途に対する速度の体感差を具体的に説明する",
      "工事料無料・ワンコインの期間特典で『今やる理由』を作る（条件は必ず添える）",
    ],
    objections: [
      {
        q: "1ギガで十分",
        a: "同時利用や在宅勤務が多い場合は10ギガの安定感が効きます。今ならワンコイン特典の期間なので、用途が合えば導入しやすいタイミングです。",
      },
    ],
    closing: "用途を伺うと10ギガが合いそうなので、特典の対象期間とエリアを確認してご案内します。",
    officialUrl: "https://www.docomo.ne.jp/campaign_event/docomo_hikari_onecoin/",
  ...
  },
  {
    ...
    name: "ドコモMAX",
    category: "料金プラン",
    oneLiner: "データ無制限。容量を気にせず動画もテザリングも使い放題の主力プラン。",
    target: "動画・SNSをよく見る方、毎月のギガが足りず速度制限にかかる方。",
    benefits: [
      "データ無制限で、月末の速度制限を気にせず使える",
      "テザリングも大容量で、外出先のPC作業や自宅Wi-Fi代わりにも",
      "dカードや光とのセット割の対象（条件は公式参照）",
    ],
    warnings: [
      "月額基本料・割引条件は変更されうるため、必ず公式ページと最終確認日を照合する（要確認）",
      "無制限でも一部用途で速度制御の可能性があるため公式の注記を確認する",
    ],
    timing: "ヒアリングで毎月のギガ不足・速度制限の不満が出たタイミング。",
    hearing: ["毎月のギガが足りているか", "動画・テザリングの利用頻度", "現在の月額と不満点"],
    pitch: [
      "『ギガを気にして我慢する時間』をなくす提案として、料金より体験で語る",
      "セット割・dカード還元と合わせて毎月の実負担を一緒に試算する",
    ],
    objections: [
      {
        q: "そんなに使わない",
        a: "使う月と使わない月の差が大きい方ほど、気にせず使える安心が効きます。まず直近のギガを一緒に見てみましょう。",
      },
    ],
    closing: "ギガを気にせず使える形にして、浮いた我慢の分を楽しい時間に回しましょう。",
  ...
  },
  {
    ...
    benefits: [
      ...
      "無制限の使い放題に、買い物のポイント還元を上乗せ",
      "dカード PLATINUM/GOLD と相性がよく、還元が積み上がる",
    ],
    warnings: [
      "『実質2,948円』は対象サービスの利用とポイント還元が前提。月額基本料は公式参照（要確認）",
      "還元率・対象条件は変更されうるため、必ず公式ページと最終確認日を照合する",
    ],
    timing: "無制限を検討中で、普段からd払い・dカードを使っていると分かったタイミング。",
    hearing: ["d払い・dカードの利用頻度", "毎月の買い物額のイメージ", "現在の月額と不満点"],
    pitch: [
      "『支払い方を変えるだけで戻ってくる』を、普段の買い物額で試算して見せる",
      "実質額は前提条件を必ず添えて、誇張せず正直に提示する",
    ],
    objections: [
      {
        q: "ポイントは結局使わない",
        a: "毎月の携帯料金やd払いに自動で充当できるので、使い道に困りません。実質の支払いが下がるイメージです。",
      },
    ],
    closing: "普段の支払いをまとめて、実質の負担を下げる形にしておきましょう。",
    officialUrl: "https://www.docomo.ne.jp/charge/docomo_poikatsu_max/",
    officialCheckedAt: "2026-06-23",
    version: 1,
  },
  {
    ...
    name: "ドコモmini",
    category: "料金プラン",
    oneLiner: "小容量4GBで最安880円〜。使う分だけのライトな料金プラン。",
    target: "スマホは連絡・少しの調べ物が中心で、ギガをあまり使わない方。",
    benefits: [
      "4GBで最安880円〜（各種割引の適用時）",
      "使う分だけの小容量で、毎月の固定費を抑えられる",
      "家族まとめ・セット割の対象（条件は公式参照）",
    ],
    warnings: [
      "『最安880円』は割引適用時の金額。適用条件は公式ページと最終確認日で照合する（要確認）",
      "ギガが不足しがちな方には MAX 系を案内し、用途に合わせて選ぶ",
    ],
    timing: "ヒアリングで『あまり使わない・料金を下げたい』が出たタイミング。",
    hearing: ["毎月のギガ使用量", "主な使い方（連絡・調べ物中心か）", "現在の月額"],
    pitch: ["『使わない分は払わない』を軸に、固定費の見直しとして提案する"],
    objections: [
      {
        q: "安いと制限が多そう",
        a: "用途が軽い方には十分な容量です。足りなくなりそうなら上位プランへ切り替えもできます。",
      },
    ],
    closing: "今の使い方なら払いすぎを抑えられるので、この形で見直しておきましょう。",
  ...
  },
  {
    ...
    name: "home 5G",
    category: "ホームルーター",
    oneLiner: "工事不要・コンセントに挿すだけ。本体は実質無料で自宅がすぐWi-Fi。",
    target: "光の工事が難しい・引っ越しが多い・自宅Wi-Fiをすぐ用意したい方。",
    benefits: [
      "本体は実質無料（分割サポート・継続利用などの条件あり）",
      "工事不要、コンセントに挿すだけで自宅がWi-Fi環境に",
      "光の開通工事が難しい住まいでも導入しやすい",
    ],
    warnings: [
      "月額料金・対象エリア・『本体実質無料』の適用条件は公式ページと最終確認日で照合する（要確認）",
      "据え置き利用が前提。光が引ける家庭では光10ギガと用途で比較する",
    ],
    timing: "自宅Wi-Fiの有無を確認し、光の工事が難しい/急ぎと分かったタイミング。",
    hearing: ["自宅のWi-Fi有無", "住まいの種別（賃貸/持ち家・工事可否）", "引っ越し予定"],
    pitch: ["『工事なし・挿すだけ・本体実質無料』の手軽さで、導入のハードルを下げる"],
    objections: [
      {
        q: "ホームルーターは遅いのでは",
        a: "5G対応エリアなら日常利用には十分な速度が出ます。エリアを一緒に確認してから判断しましょう。",
      },
    ],
    closing: "工事なしですぐ使えるので、自宅のWi-Fiは今日この形で整えておきましょう。",
...
export const TALK_SCRIPTS: TalkScript[] = [
  {
    id: "ts-mall-5step",
    title: "モール外販・標準5ステップ接客（他社ユーザー／乗り換え抵抗が強い方）",
    category: "外販／ヒアリング／5ステップ",
    target: "ショッピングモールを通行中の、ドコモ以外を利用し乗り換え経験がないお客様",
    difficulty: 7,
    timing: "通行のキャッチから着座・料金診断まで。聞かないと情報を出さない相手が前提。",
    sections: [
      {
        heading: "マインドセット：すべては自分のアプローチの結果",
        lines: [
          "断られても『この人は買わない人』ではなく『自分の伝え方をどう変えるか』で考える（自責思考）。",
          "売り込むのではなく、今の不満を一緒に見つけて、乗り換えた後の明るい毎日を描く。",
          "笑顔・挨拶・身だしなみ（5S）で、まず警戒を解いて『話してもいい人』になる。",
        ],
        note: "目的は『安さ』の説明ではなく、着座と料金診断まで進めること。",
      },
      {
        heading: "① 興味付け（キャッチ）：足を止める入口を作る",
        lines: [
          "景品やティッシュ、東京ポイントアプリなど、受け取りやすいフックから入る。",
          "旬の話題（例：ワールドカップ）や抽選会、その場の操作の困りごとをきっかけにする。",
          "「スマホの操作でお困りのことありませんか？」と、売り込みでない一言で止まってもらう。",
        ],
      },
      {
        heading: "② ヒアリング：聞かないと出てこない情報を引き出す",
        lines: [
          "現状のキャリア・機種・毎月の通信料を、雑談の流れでやさしく確認する。",
          "不満（動きが遅い・電池が持たない・ギガが足りない）と、自宅のWi-Fiの有無を特定する。",
          "本人確認書類の有無・未納・家族に相談が必要かも、雑談の中で早めに確認しておく。",
        ],
        note: "失敗の多くは書類不足・未納・家族相談。早期に把握すれば着座後の手戻りを防げる。",
      },
      {
        heading: "③ メリット提案：3つの価値を連動させる",
        lines: [
          "端末スペック：今の機種の不満（動作・電池）を、新しい機種でどう解消できるか。",
          "料金最適化：使い方に合うプラン（MAX／ポイ活MAX／mini）で、払いすぎを見直す。",
          "自宅ネット：ドコモ光やhome 5Gで家のWi-Fiまで整え、家計ごとお得にする。",
        ],
        note: "単品の安さでなく、3つを束ねた『乗り換え後の生活』として見せる。",
      },
      {
        heading: "④ 着座誘導・合意：座って一緒に料金診断",
        lines: [
          "「今の不満を解消して、浮いたお金で家族で外食にも行けますよ」と前向きな未来で誘う。",
          "「今のスマホ、少し古くないですか？ せっかくなので一度だけ料金を見てみましょう」と着座へ。",
          "信頼感（笑顔・挨拶・丁寧さ）をベースに、押し売り感を出さず合意を取る。",
        ],
      },
      {
        heading: "⑤ お見送り：次につながる関係を残す",
        lines: [
          "成約・未成約にかかわらず、最後まで丁寧にお見送りして信頼を残す。",
          "その場で決まらなくても、必要書類や家族相談の宿題を渡し、再来店につなげる。",
        ],
      },
    ],
    ngExamples: [
      "いきなり料金やキャンペーンの数字から入り、不満を聞く前に売り込む",
      "他社を否定する／『安いですよ』だけで押し、乗り換えの不安に触れない",
      "書類・未納・家族相談の確認を後回しにして、着座後に手続きが止まる",
    ],
    goodExamples: [
      "受け取りやすいフックで足を止め、雑談の中で現状と不満を引き出してから提案する",
      "端末・料金・自宅ネットの3価値を束ね、『乗り換え後の明るい毎日』として描く",
      "『浮いたお金で家族と外食』など、生活が良くなる具体像で着座へつなげる",
    ],
    note: "料金・特典・実質額は必ず公式ページと最終確認日で照合する。事実は盛らず、条件を添えて正直に。",
  },
  {
    id: "ts-gold",
...
export const OBJECTIONS: ObjectionHandler[] = [
  ...
  {
    id: "obj-never-switched",
    objection: "乗り換えたことがなくて不安",
    background: "MNPや手続きの経験がなく、面倒・失敗が怖いという心理的ハードルが高い。",
    ng: "「簡単ですよ」とだけ言って手順を省く。",
    good: "「初めてだと不安ですよね。番号もそのまま、手続きはこちらで一緒に進めるので、やることはほぼ確認だけです」と寄り添って具体化する。",
    reframe: "不安の正体（手間・失敗・番号変更）を一つずつ潰し、こちらが伴走する前提で示す。",
    closing: "番号はそのまま、難しいところは一緒に進めます。今日この場で確認しながら整えましょう。",
  },
  {
    id: "obj-no-trouble",
    objection: "今ので困っていない",
    background: "不満を言語化できていない。聞かれないと現状の我慢に気づいていない。",
    ng: "「絶対こっちがお得です」と一方的に被せる。",
    good: "「困っていないのが一番ですよね。念のため、月末にギガが足りるか・電池の持ち・毎月の料金だけ一緒に見てみませんか」と小さな確認に誘う。",
    reframe: "『困りごと探し』を一緒に行い、我慢している点（ギガ・電池・料金）を可視化する。",
    closing: "見てみて今のままが良ければそれで大丈夫です。まず料金だけ一度確認しておきましょう。",
  },
  {
    id: "obj-busy",
    objection: "今は時間がない／面倒",
    background: "通行中で立ち止まりたくない、手続きの時間を読めない。",
    ng: "長い説明で引き止める。",
    good: "「お急ぎですよね。3分だけ、今の料金が下がる余地があるかだけ見ます。続きはご都合の良い時で大丈夫です」と所要を区切る。",
    reframe: "所要時間を短く区切り、その場の負担を最小化して着座のハードルを下げる。",
    closing: "まず3分で見て、良ければ続けましょう。今のお手元の料金が分かるものはありますか。",
  },
];
