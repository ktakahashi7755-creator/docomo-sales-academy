...
import { CATCH_SCRIPTS } from "./catchScripts";
...
export const PHASES: Phase[] = [
  {
    ...
    modules: [
      { id: "p1m1", title: "携帯販売ヘルパーの役割", passing_score: 80, required: true, estimated_minutes: 15 },
      { id: "p1m2", title: "店内・イベント・外販の動き方", passing_score: 80, required: true, estimated_minutes: 20 },
      { id: "p1m3", title: "受付から提案までの流れ", passing_score: 80, required: true, estimated_minutes: 15 },
      { id: "p1m4", title: "個人情報・コンプライアンス／やってはいけないこと", passing_score: 100, required: true, estimated_minutes: 20 },
    ],
  },
  {
    id: "p2",
    ...
    modules: [
      { id: "p2m1", title: "ドコモ料金プラン（MAX / ポイ活MAX / mini）", passing_score: 80, required: true, estimated_minutes: 25 },
      { id: "p2m2", title: "ahamoとの違い・通話オプション", passing_score: 80, required: true, estimated_minutes: 15 },
      { id: "p2m3", title: "ギガ使用量の確認・家族まとめ", passing_score: 80, required: true, estimated_minutes: 15 },
    ],
  },
  {
    id: "p3",
    ...
    modules: [
      { id: "p3m1", title: "dカード 3種の違い（年会費・還元・補償）", passing_score: 80, required: true, estimated_minutes: 20 },
      { id: "p3m2", title: "GOLD提案トーク", passing_score: 90, required: true, estimated_minutes: 25 },
      { id: "p3m3", title: "PLATINUM提案トーク", passing_score: 90, required: true, estimated_minutes: 25 },
      { id: "p3m4", title: "dカード 反論処理", passing_score: 80, required: true, estimated_minutes: 20 },
    ],
  },
  {
    id: "p4",
    ...
    modules: [
      { id: "p4m1", title: "ドコモ光 1ギガ / 10ギガ", passing_score: 80, required: true, estimated_minutes: 20 },
      { id: "p4m2", title: "事業者変更・転用・乗り換え手順", passing_score: 80, required: true, estimated_minutes: 20 },
      { id: "p4m3", title: "光セット提案 / home 5Gとの違い", passing_score: 80, required: true, estimated_minutes: 15 },
    ],
  },
  {
    id: "p5",
    ...
    modules: [
      { id: "p5m1", title: "ドコモでんき・ガスの基礎", passing_score: 80, required: true, estimated_minutes: 15 },
      { id: "p5m2", title: "家計全体での提案・dポイント還元", passing_score: 80, required: true, estimated_minutes: 15 },
    ],
  },
  {
    id: "p6",
    ...
    modules: [
      { id: "p6m1", title: "基本ヒアリングの型", passing_score: 80, required: true, estimated_minutes: 20 },
      { id: "p6m2", title: "不満・乗り換え意欲の引き出し", passing_score: 80, required: true, estimated_minutes: 15 },
    ],
  },
  {
    id: "p7",
    ...
    modules: [
      { id: "p7m1", title: "単品提案・セット提案", passing_score: 80, required: true, estimated_minutes: 20 },
      { id: "p7m2", title: "家族まとめ・MNP・ポイ活提案", passing_score: 80, required: true, estimated_minutes: 20 },
    ],
  },
  {
    id: "p8",
    ...
    modules: [
      { id: "p8m1", title: "価格・面倒・保留への切り返し", passing_score: 80, required: true, estimated_minutes: 25 },
      { id: "p8m2", title: "他社経済圏への切り返し", passing_score: 80, required: true, estimated_minutes: 20 },
    ],
  },
  {
    id: "p9",
    ...
    modules: [
      { id: "p9m1", title: "クロージングの型", passing_score: 80, required: true, estimated_minutes: 25 },
      { id: "p9m2", title: "申込誘導・最後の一押し", passing_score: 80, required: true, estimated_minutes: 20 },
    ],
  },
  {
    id: "p10",
    ...
    modules: [
      { id: "p10m1", title: "商材テスト（90点以上）", passing_score: 90, required: true, estimated_minutes: 30 },
      { id: "p10m2", title: "総合ロープレ＋SV評価", passing_score: 80, required: true, estimated_minutes: 40 },
    ],
  },
];
...
export const PRODUCTS: Product[] = [
  {
    ...
    objections: [
      { q: "年会費が高い", a: "割引約6,600円＋ポイント約12,000Pで実質プラスになる使い方を一緒に確認しましょう。" },
      { q: "ポイントは使わない", a: "d払いや毎月の携帯料金の支払いに自動で充当できるので、使い道に困りません。" },
    ],
    closing:
  ...
  },
  {
    ...
    objections: [
      { q: "年会費が高い／そこまで必要ない", a: "実利用額で試算すると、ポイントだけで年会費を超える方が多いので一度計算してみましょう。" },
      { q: "GOLDで二重に年会費がかかりそう", a: "切替時は11,000円が相殺され、実質18,700円で初年度お試しできます。合わなければGOLDに戻せます。" },
    ],
    closing:
  ...
  },
  {
    ...
    benefits: ["スマホとの光セット割", "家族台数が多いほどセット割の効果が大きい", "dポイント還元・各種特典"],
  ...
  },
  {
    ...
    benefits: ["多くの場合、工事不要・解約手続き不要", "dカード支払いでdポイント還元", "家計全体での提案がしやすい"],
...
// ===== トークスクリプト（POPからの正データ） =====
const PRODUCT_SCRIPTS: TalkScript[] = [
  {
    id: "ts-gold",
...
/** キャッチ系 + 商材系を統合した全トークスクリプト */
export const TALK_SCRIPTS: TalkScript[] = [...CATCH_SCRIPTS, ...PRODUCT_SCRIPTS];
...
export const SCENARIOS: Scenario[] = [
  { id: "sc1", no: 1, title: "楽天・一人暮らし・料金重視", carrier: "楽天モバイル", familyType: "一人利用", internetLine: "未契約", interest: "普通", resistance: "普通", difficulty: 3, goal: "料金診断・MNP提案" },
  { id: "sc2", no: 2, title: "SB・家族4人・SB光・PayPay圏", carrier: "ソフトバンク", familyType: "家族利用", internetLine: "ソフトバンク光", interest: "普通", resistance: "高い", difficulty: 6, goal: "セット提案" },
  { id: "sc3", no: 3, title: "au・夫婦・auひかり・カード抵抗", carrier: "au", familyType: "夫婦利用", internetLine: "auひかり", interest: "低い", resistance: "高い", difficulty: 7, goal: "dカード提案" },
  { id: "sc4", no: 4, title: "ワイモバイル・家族・サポート不満", carrier: "ワイモバイル", familyType: "家族利用", internetLine: "不明", interest: "普通", resistance: "普通", difficulty: 5, goal: "家族まとめ提案" },
  { id: "sc5", no: 5, title: "UQ・通信品質不満・光検討", carrier: "UQモバイル", familyType: "一人利用", internetLine: "未契約", interest: "高い", resistance: "普通", difficulty: 4, goal: "ドコモ光提案" },
  { id: "sc6", no: 6, title: "ドコモ既存・レギュラー・GOLD対象", carrier: "ドコモ既存", familyType: "一人利用", internetLine: "ドコモ光", interest: "普通", resistance: "普通", difficulty: 4, goal: "dカード提案（GOLD）" },
  { id: "sc7", no: 7, title: "ドコモ既存・GOLD・PLATINUM対象", carrier: "ドコモ既存", familyType: "家族利用", internetLine: "ドコモ光", interest: "高い", resistance: "高い", difficulty: 7, goal: "PLATINUM提案・ポイ活MAX" },
  { id: "sc8", no: 8, title: "高齢・操作不安・店舗サポート重視", carrier: "ドコモ既存", familyType: "一人利用", internetLine: "不明", interest: "普通", resistance: "普通", difficulty: 5, goal: "機種変更提案" },
  { id: "sc9", no: 9, title: "家族確認が必要・即決しない", carrier: "au", familyType: "家族利用", internetLine: "不明", interest: "低い", resistance: "高い", difficulty: 8, goal: "クロージング" },
  { id: "sc10", no: 10, title: "料金に非常に厳しい・即決拒否", carrier: "ソフトバンク", familyType: "一人利用", internetLine: "未契約", interest: "低い", resistance: "高い", difficulty: 9, goal: "クロージング" },
];
...
// ===== クローザー認定条件 =====
export const CERT_CONDITIONS: CertCondition[] = [
  { id: "c1", label: "全必須モジュール合格", done: false },
  { id: "c2", label: "商材テスト90点以上", done: false },
  { id: "c3", label: "コンプライアンステスト100点", done: false },
  { id: "c4", label: "音声ロープレ平均80点以上", done: false },
  { id: "c5", label: "難易度7以上のロープレでA評価3回以上", done: false },
  { id: "c6", label: "dカード提案ロープレ合格", done: false },
  { id: "c7", label: "光提案ロープレ合格", done: false },
  { id: "c8", label: "セット提案ロープレ合格", done: false },
  { id: "c9", label: "クロージングロープレ合格", done: false },
  { id: "c10", label: "SV承認", done: false },
];
