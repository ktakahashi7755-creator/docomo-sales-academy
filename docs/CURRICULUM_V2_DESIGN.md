...
| B     | 標準販売プロセス(15工程)・場面別トーク集・ヒアリング項目・反論処理集の分離データ化 | 未着手   |
| C     | 全19レッスン本文の深掘り（チャネル差・条件付き表現・コンプラ注記）                 | 未着手   |
| D     | AIロープレシナリオ拡充・確認テスト強化（各レッスン3問以上・コンプラ100点）         | 未着手   |
| E     | UI階層化（プロセス/トーク集/反論集画面）・SV評価ルーブリック・最終ドキュメント     | 未着手   |
